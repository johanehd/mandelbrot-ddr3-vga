...
entity vga_controller is
  port (
    ...
    pixel_y_gray_o : out std_logic_vector(9 downto 0);
...
architecture Behavioral of vga_controller is
  ...
  signal v_cnt_gray    : std_logic_vector(9 downto 0) := (others => '0');
...
begin
  ...
  begin
    if rst = '1' then
      ...
      v_cnt_gray <= to_gray(std_logic_vector(v_cnt));
    end if;
  end process;
